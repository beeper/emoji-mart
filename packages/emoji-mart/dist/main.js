...
function $47b4a70d4572a3b3$var$__init() {
    $47b4a70d4572a3b3$var$__init = (0, (/*@__PURE__*/$parcel$interopDefault($f653aaea2ce76311$exports)))((0, (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports))).mark(function _callee(props) {
        var emojiVersion, set, locale, alias, emojiId, emoji, i, category, prevCategory, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, emoji1, latestVersionSupport, noCountryFlags, categoryIndex, resetSearchIndex, category1, maxFrequentRows, perLine, customFrequentlyUsed, categoryIcons, icon, emojiIndex, emojiId1, emoji2, ignore, _iteratorNormalCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, emoticon, skinIndex, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, skin, native, skinShortcodes;
        return (0, (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports))).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                ...
                case 93:
                    ...
                    if (category1.id == "frequent") {
                        maxFrequentRows = props.maxFrequentRows, perLine = props.perLine, customFrequentlyUsed = props.customFrequentlyUsed;
                        ...
                        if (customFrequentlyUsed === null || customFrequentlyUsed === void 0 ? void 0 : customFrequentlyUsed.enabled) category1.emojis = customFrequentlyUsed.values;
                        else category1.emojis = (0, $79925e24c549250c$export$2e2bcd8739ae039).get({
        ...
        },
        {
            ...
            value: function handleEmojiClick(param) {
                ...
                if (emoji) {
                    ...
                    if (!((ref = this.props.customFrequentlyUsed) === null || ref === void 0 ? void 0 : ref.enabled) && this.props.maxFrequentRows) (0, $79925e24c549250c$export$2e2bcd8739ae039).add(emojiData, this.props);
