...
async function $7adb23b0109cc36a$var$_init(props) {
    ...
    while(categoryIndex--){
        ...
        if (category.id == "frequent") {
            let { maxFrequentRows: maxFrequentRows , perLine: perLine , customFrequentlyUsed: customFrequentlyUsed  } = props;
            ...
            if (customFrequentlyUsed?.enabled) category.emojis = customFrequentlyUsed.values;
            else category.emojis = (0, $b22cfd0a55410b4f$export$2e2bcd8739ae039).get({
...
class $89bd6bb200cc8fef$export$2e2bcd8739ae039 extends (0, $fb96b826c0c5f37a$export$16fa2f45be04daa8) {
    ...
    handleEmojiClick({ e: e , emoji: emoji , pos: pos  }) {
        ...
        if (emoji) {
            ...
            if (!this.props.customFrequentlyUsed?.enabled && this.props.maxFrequentRows) (0, $b22cfd0a55410b4f$export$2e2bcd8739ae039).add(emojiData, this.props);
